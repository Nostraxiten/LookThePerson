...
class PoseModel:
    ...
    def __init__(self, num_poses=MAX_POSES, confidence=0.35, segmentation=True):
        """
        Args:
            num_poses: how many people to track at once.
            confidence: detection, presence and tracking threshold.
            segmentation: produce person masks (needed by the background and
                silhouette effects; costs noticeable time when unused).
        """
        self._detector = None
    ...
    def start(self):
        ...
        options = vision.PoseLandmarkerOptions(
            ...
            output_segmentation_masks=self.segmentation,
        )
